...
For example, when users input the keywords like “a large Screen Size laptop“, our approach could map the associated features and and give high quality recommendations (Fig.1: <small>Our approach to predicting the attributes based on the input “A large Screen Size laptop”</small>).
